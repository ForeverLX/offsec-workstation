...
Item {
    id: controlCenter
    property string widgetName: "controlcenter"
    property var mpd
    property var vpn
    property var podman
    ...
    GlassPanel {
        ...
        ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle { width: 34; height: 34; radius: 17; color: mocha.mauve
                            Text { anchors.centerIn: parent; text: (mpd && mpd.playing) ? "\u23F8" : "\u25B6"; color: "#fff"; font.pixelSize: 13 }
            ...
            GridLayout {
                ...
                ToggleButton { icon: "\uD83D\uDD12"; label: vpn && vpn.connected ? "VPN" : "VPN Off"; active: vpn && vpn.connected; onClicked: vpn.toggle() }
            ...
            // === PODMAN QUICK VIEW ===
            Text {
                text: "\uD83D\uDC0B Containers (" + (podman ? podman.count : 0) + ")"
                color: mocha.text; font.pixelSize: 13; font.bold: true
            }
            ...
            ListView {
                ...
                clip: true; spacing: 4
                model: podman ? podman.containers : []
